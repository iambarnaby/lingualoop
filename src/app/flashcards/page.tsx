          ...
          >
            ...
            >
              <div className={`flashcard-inner relative w-full h-full ${isFlipped ? 'flipped' : ''}`}>
                {/* Front */}
                <div className="flashcard-front absolute inset-0 glass rounded-2xl flex flex-col items-center justify-center p-8">
                ...
                {/* Back */}
                <div className="flashcard-back absolute inset-0 glass rounded-2xl flex flex-col items-center justify-center p-8 border-accent/20">
